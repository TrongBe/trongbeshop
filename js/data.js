export const mockQuizzes = [
    ...
    },
    {
        ...
        questions: [
            ...
            { id: "q66", section: "PHẦN 2. TOÁN HỌC", text: "Câu 66: Một công ty viễn thông đang lên kế hoạch mở rộng mạng lưới dịch vụ của mình tại một khu vực gồm sáu thị trấn: A, B, C, D, E và F. Để cung cấp dịch vụ internet và điện thoại đến từng thị trấn, công ty cần phải kéo cáp ngầm nối các thị trấn với nhau. Mỗi đoạn cáp nối hai thị trấn có một chi phí nhất định, tùy thuộc vào khoảng cách địa lý và điều kiện địa hình. Sơ đồ dưới đây thể hiện các tuyến cáp có thể xây dựng, cùng với chi phí đi kèm (tính bằng nghìn đô la) cho từng tuyến.<br><br><b>Sơ đồ tuyến cáp (thị trấn: chi phí nghìn đô la):<img src=\"https://i.ibb.co/twSqV6SV/Screenshot-2026-05-14-223438.png\"></b><br>Chi phí tối thiểu (nghìn đô la) mà công ty phải bỏ ra để xây dựng hệ thống cáp sao cho tất cả sáu thị trấn đều được kết nối với nhau là:", options: ["A. 780.", "B. 820.", "C. 760.", "D. 800."], correctIndex: 0 },
