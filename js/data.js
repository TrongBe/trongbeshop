export const mockQuizzes = [
    ...
    },
    {
        ...
        questions: [
            // PHẦN I: TRẮC NGHIỆM
            { id: "bio_q1", section: "PHẦN I: TRẮC NGHIỆM", type: "multiple_choice", text: "Các số (1) và (2) trong hình cấu trúc neuron tương ứng với thành phần nào? <br>(1: Thân neuron, 2: Sợi nhánh)", options: ["A. Sợi nhánh và thân neuron", "B. Nhân và sợi nhánh", "C. Thân neuron và sợi nhánh", "D. Sợi trục và nhân"], correctIndex: 1 },
